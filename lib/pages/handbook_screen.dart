...
class _HandbookScreenState extends State<HandbookScreen> {
  ...
  final List<Map<String, dynamic>> formulas = [
    {
      ...
      'latexHandbook': r'x = \frac{-b \pm \sqrt{b^2 - 4ac}}{2a}',
      'fullDescription':
  ...
  List<Map<String, dynamic>> get filteredHandbook {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: filteredHandbook.length,
        itemBuilder: (context, index) {
          final formula = filteredHandbook[index];
          return InkWell(
            onTap: () {
              Navigator.push(
                context,
